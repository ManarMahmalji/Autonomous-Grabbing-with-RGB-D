...
## Version (1)     
############################################################
# This code serves for tuning the static block criteria limits 
    ...
    while True:
        ...
        if len(corners) > 0: # if there is at least one marker detected
            ...
            if markNum != 0:
                ...
                pt_wrt_base1= [a,b,c] # final grabbing point wrt base frame 
                ...
                b= t_cam2base[1]+rotated_point[1]
                c= t_cam2base[2]+rotated_point[2]
                pt_wrt_base2= [a,b,c] # intermediate grabbing point wrt base frame 
                ...
                if k>Buffer_size:
                    ...
                    #tuning the limits of the static block criteria. You can change them,
                    # then actively see when the block is condidered static or moving 
                    if rot_cond and pos_cond: 
                       static_block= True
                    else:
                       static_block= False
